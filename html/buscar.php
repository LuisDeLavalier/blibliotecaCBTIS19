<?php
	...
	#echo "3";
	 $mos=mysqli_query($con,"SELECT * FROM `libros` WHERE `Nombre_Libro`LIKE'%$ge%' OR `Autor`LIKE'%$ge%'OR `ISBN`LIKE'%$ge%'")or die("problemas al extrar datos");
	#echo "4";	
...
<div style="clear:both"></div>
		...
		<SECTION>
		<h1>RESULTADO DE : <?php echo "$ge"; ?></h1>
			<?php
