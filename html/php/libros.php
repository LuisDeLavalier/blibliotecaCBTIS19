...
<div style="clear:both"></div>
	...
	while ($fila=mysqli_fetch_array($mos) ) {
		?>
		<div id="in">
			<img height="50" src="data:image/jpg;base64,<?php echo base64_encode($fila[img]);?>">

		<p id="nombre"><?php echo "Nombre: $fila[Nombre]";?></p>
		<p id="typo"><?php echo "Tipo: $fila[Typo]<br>";?></p>
		<p id="materia"><?php echo "Materia: $fila[Materia]<br>";?></p>
		<p id="autor"><?php echo "Autor: $fila[Autor]<br>";?></p>
		<p id="despcrision"><?php echo "Descripcion: $fila[Describcion]<br>";?></p>
		</div>
		<div id="libr">
			<p><?php echo "URL: $fila[url]<br>";?></p>
		</div>
